...
```
<img src="/Images/DTC/EDA_2_Hep.png" class="inline"/><br>
...
def minorEDA(df):
    ...
    print(lineBreak*3)
```
<img src="/Images/DTC/EDA_1_Hep.png" class="inline"/><br>
...
```
<img src="/Images/DTC/graph_viz.png" class="inline"/><br>
...
def DecisionTree():
    # Build Decision Tree Classifier
    dtc = DecisionTreeClassifier(max_depth = 6, random_state=5)
    return dtc
